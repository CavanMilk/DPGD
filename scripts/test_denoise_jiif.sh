...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=9 python main.py --test --checkpoint best --name denoise_jiif_16 --model JIIF --dataset NoisyMiddlebury --scale 16 --interpolation bicubic --data_root ./data/noisy_depth/middlebury --batched_eval --report_per_image