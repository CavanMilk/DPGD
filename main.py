...
# dataloader
if not args.test:
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.train_batch, pin_memory=False, drop_last=False, shuffle=True, num_workers=args.num_workers)
